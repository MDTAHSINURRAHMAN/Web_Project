            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <b>Mobile Number</b> <a class="float-right">{{ Auth::user()->phone }}</a>
                  </li>
                ...
                <a href="{{ url('/home/profile/'.$user->id) }}" class="btn btn-primary btn-block"><i class="fa fa-edit"></i> Edit Profile</a>
