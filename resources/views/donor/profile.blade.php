                    ...
                    <form action="{{ url('home/profile/'.$user->id) }}" method="POST" aria-label="{{ __('Profile') }}"">
                        ...
                        <div class="form-group">
                            ...
                            <p class="hint--top" data-hint="Blood Group" id="input-field">
                                <input type="text" name="blood_group" class="form-control @error('blood_group') is-invalid @enderror" value="{{ $user->blood_group }}" placeholder="Blood Group" required autocomplete="blood_group" autofocus>
                                @error('blood_group')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
